...
public class DatabaseContract {
	...
	public static final String COLUMN_TARGET_LEVEL = "target_level";
	public static final String COLUMN_SHORT_LEVEL = "short_level";
	public static final String COLUMN_LONG_LEVEL = "long_level";
	...
	public static final String COLUMN_HEDGEABLE = "hedgeable";

	public static final String COLUMN_TREND_THUMBNAIL = COLUMN_TREND_THUMBNAIL();
	public static final String COLUMN_RADAR_THUMBNAIL = COLUMN_RADAR_THUMBNAIL();
	...
	public static final String COLUMN_RADAR = "radar";
	...
	public static final String COLUMN_RADAR_THUMBNAIL() {
		return COLUMN_RADAR + "_" + COLUMN_THUMBNAIL;
	}
	...
	public static boolean isPeriodThumbnailColumn(String columnName) {
		return 	DatabaseContract.COLUMN_MONTH_THUMBNAIL.equals(columnName) ||
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = {_ID,
				...
				COLUMN_BUY_PROFIT, COLUMN_SELL_PROFIT, COLUMN_TREND_THUMBNAIL, COLUMN_RADAR_THUMBNAIL,
				...
				COLUMN_TARGET_LEVEL, COLUMN_SHORT_LEVEL, COLUMN_LONG_LEVEL, COLUMN_TREND, COLUMN_SIGNAL, COLUMN_TEE, COLUMN_HEDGEABLE,
				COLUMN_FLAG,
				COLUMN_ROI, COLUMN_IR, COLUMN_IRR, COLUMN_ROE, COLUMN_PE, COLUMN_PB,
				COLUMN_LOCKED, COLUMN_QUOTA, COLUMN_TRADING, COLUMN_HOLD, COLUMN_PROFIT, COLUMN_BONUS, COLUMN_BONUS_IN_YEAR, COLUMN_VALUATION, COLUMN_COST,
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ COLUMN_RADAR_THUMBNAIL + BLOB_TYPE + COMMA_SEP
				...
				+ COLUMN_TARGET_LEVEL + TEXT_TYPE + COMMA_SEP
				+ COLUMN_SHORT_LEVEL + TEXT_TYPE + COMMA_SEP
				+ COLUMN_LONG_LEVEL + TEXT_TYPE + COMMA_SEP
				+ COLUMN_TREND + TEXT_TYPE + COMMA_SEP
				+ COLUMN_SIGNAL + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_TEE + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_HEDGEABLE + INTEGER_TYPE + COMMA_SEP
				...
				+ COLUMN_LOCKED + INTEGER_TYPE + COMMA_SEP
	...
	public static abstract class StockRadar implements BaseColumns {
		public static final String TABLE_NAME = "stock_radar";
