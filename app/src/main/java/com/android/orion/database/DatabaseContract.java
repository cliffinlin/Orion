...
public class DatabaseContract {
	...
	public static final String COLUMN_MONTH6_LEVEL = COLUMN_MONTH6 + "_" + COLUMN_LEVEL;
	public static final String COLUMN_QUARTER_LEVEL = COLUMN_QUARTER + "_" + COLUMN_LEVEL;
	public static final String COLUMN_MONTH2_LEVEL = COLUMN_MONTH2 + "_" + COLUMN_LEVEL;
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = {_ID,
				...
				COLUMN_YEAR, COLUMN_MONTH6, COLUMN_QUARTER, COLUMN_MONTH2, COLUMN_MONTH, COLUMN_WEEK, COLUMN_DAY, COLUMN_MIN60, COLUMN_MIN30, COLUMN_MIN15, COLUMN_MIN5,
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ COLUMN_YEAR + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MONTH6 + BLOB_TYPE + COMMA_SEP
				+ COLUMN_QUARTER + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MONTH2 + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MONTH + BLOB_TYPE + COMMA_SEP
				+ COLUMN_WEEK + BLOB_TYPE + COMMA_SEP
				+ COLUMN_DAY + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MIN60 + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MIN30 + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MIN15 + BLOB_TYPE + COMMA_SEP
				+ COLUMN_MIN5 + BLOB_TYPE + COMMA_SEP
