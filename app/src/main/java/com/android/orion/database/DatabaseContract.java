...
public class DatabaseContract {
	...
	public static final String COLUMN_QUOTA_EST = "quota_est";
	public static final String COLUMN_TRADING = "trading";
	public static final String COLUMN_TRADING_COST = "trading_cost";
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = {_ID,
				...
				COLUMN_BUY_PROFIT, COLUMN_SELL_PROFIT, COLUMN_PREDICT, COLUMN_TREND_THUMBNAIL, COLUMN_RADAR_THUMBNAIL,
				...
				COLUMN_LEVEL, COLUMN_TARGET, COLUMN_TREND,
				COLUMN_FLAG,
				COLUMN_ROI, COLUMN_IR, COLUMN_IRR, COLUMN_ROE, COLUMN_PE, COLUMN_PB, COLUMN_PR,
				COLUMN_QUOTA, COLUMN_QUOTA_EST, COLUMN_TRADING, COLUMN_TRADING_COST, COLUMN_HOLD, COLUMN_PROFIT, COLUMN_BONUS, COLUMN_BONUS_IN_YEAR, COLUMN_VALUATION, COLUMN_COST,
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ COLUMN_QUOTA_EST + DOUBLE_TYPE + COMMA_SEP
	...
	public static abstract class StockData implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = {_ID,
				...
				COLUMN_AVERAGE5, COLUMN_AVERAGE10, COLUMN_DIF, COLUMN_DEA, COLUMN_HISTOGRAM, COLUMN_RADAR,
				COLUMN_CREATED, COLUMN_MODIFIED};
		static final String DELETE_TABLE = DROP_TABLE_IF_EXISTS
				+ TABLE_NAME;
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ COLUMN_RADAR + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_CREATED + TEXT_TYPE + COMMA_SEP
				+ COLUMN_MODIFIED + TEXT_TYPE + " )";
		static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				+ CREATE_TABLE_CONTENT;
