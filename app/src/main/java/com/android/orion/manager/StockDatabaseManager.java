...
public class StockDatabaseManager extends DatabaseManager implements StockListener {
    ...
    public int deleteStock(long id) {
        return delete(DatabaseContract.Stock.CONTENT_URI, getIDSelection(id), null);
    }

    public int updateStock(Stock stock, ContentValues contentValues) {
        return update(DatabaseContract.Stock.CONTENT_URI, contentValues, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public Cursor queryStock(Stock stock) {
        return queryStock(getStockSelection(stock.getSE(), stock.getCode()), null, null);
    }
    ...
    public void loadStockArrayMap(ArrayMap<String, Stock> stockArrayMap) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStock(getFlagSelection(Stock.FLAG_FAVORITE), null, null);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
                    Stock stock = new Stock();
                    stock.set(cursor);
    ...
    public void getStockById(Stock stock) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStock(getIDSelection(stock.getId()), null, null);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                cursor.moveToNext();
                stock.set(cursor);
            }
    ...
    public int deleteStockBonus(Stock stock) {
        return delete(DatabaseContract.StockBonus.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public int updateStockBonus(StockBonus stockBonus, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockBonus.CONTENT_URI, contentValues, getStockDateSelection(stockBonus.getSE(), stockBonus.getCode(), stockBonus.getDate()),null);
    }
    ...
    public void getStockBonusList(Stock stock, ArrayList<StockBonus> stockBonusList, String sortOrder) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockBonus(getStockSelection(stock.getSE(), stock.getCode()), null, sortOrder);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
    ...
    public int deleteStockData(Stock stock) {
        return delete(DatabaseContract.StockData.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }

    public int deleteStockData(String se, String code, String period) {
        return delete(DatabaseContract.StockData.CONTENT_URI, getStockPeriodSelection(se, code, period), null);
    }

    public int updateStockData(long id, ContentValues contentValues) {
        return update(DatabaseContract.StockData.CONTENT_URI, contentValues, getIDSelection(id),null);
    }

    public int updateStockData(StockData stockData, ContentValues contentValues) {
        return update(DatabaseContract.StockData.CONTENT_URI, contentValues, getStockPeriodDateTimeSelection(stockData.getSE(), stockData.getCode(), stockData.getPeriod(), stockData.getDate(), stockData.getTime()),null);
    }
    ...
    public void deleteStockDeal(StockDeal stockDeal) {
        ...
        delete(DatabaseContract.StockDeal.CONTENT_URI,	getIDSelection(stockDeal.getId()), null);
    }
    ...
    public int updateStockDealByID(StockDeal stockDeal) {
        ...
        return update(DatabaseContract.StockDeal.CONTENT_URI, stockDeal.getContentValues(), getIDSelection(stockDeal.getId()), null);
    }
    ...
    public Cursor queryStockDeal(long id) {
        return queryStockDeal(getIDSelection(id), null, null);
    }
    ...
    public int deleteStockFinancial(Stock stock) {
        return delete(DatabaseContract.StockFinancial.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public int updateStockFinancial(StockFinancial stockFinancial, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockFinancial.CONTENT_URI, contentValues, getStockDateSelection(stockFinancial.getSE(), stockFinancial.getCode(), stockFinancial.getDate()), null);
    }
    ...
    public void getStockFinancialList(Stock stock, ArrayList<StockFinancial> stockFinancialList, String sortOrder) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockFinancial(getStockSelection(stock.getSE(), stock.getCode()), null, sortOrder);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
    ...
    public int updateStockGrid(StockGrid stockGrid, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockGrid.CONTENT_URI, contentValues, getStockTypeSelection(stockGrid.getSE(), stockGrid.getCode(), stockGrid.getType()),null);
    }
    ...
    public Cursor queryStockGrid(StockGrid stockGrid) {
        ...
        String selection = getStockTypeSelection(stockGrid.getSE(), stockGrid.getCode(), stockGrid.getType());
    ...
    public int deleteStockPerceptron(long id) {
        return delete(DatabaseContract.StockPerceptron.CONTENT_URI, getIDSelection(id), null);
    }
    ...
    public int updateStockPerceptron(StockPerceptron stockPerceptron, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockPerceptron.CONTENT_URI, contentValues, getPeriodLevelTypeSelection(stockPerceptron.getPeriod(), stockPerceptron.getLevel(), stockPerceptron.getType()),null);
    }
    ...
    public void getStockPerceptronById(StockPerceptron stockPerceptron) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockPerceptron(getIDSelection(stockPerceptron.getId()), null, null);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                cursor.moveToNext();
                stockPerceptron.set(cursor);
            }
    ...
    public int deleteStockRZRQ(Stock stock) {
        return delete(DatabaseContract.StockRZRQ.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public int updateStockRZRQ(StockRZRQ stockRZRQ, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockRZRQ.CONTENT_URI, contentValues, getStockDateSelection(stockRZRQ.getSE(), stockRZRQ.getCode(), stockRZRQ.getDate()),null);
    }
    ...
    public void getStockRZRQList(Stock stock, ArrayList<StockRZRQ> stockRZRQList, String sortOrder) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockRZRQ(getStockSelection(stock.getSE(), stock.getCode()), null, sortOrder);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
    ...
    public void getStockShareList(Stock stock, ArrayList<StockShare> stockShareList, String sortOrder) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockShare(getStockSelection(stock.getSE(), stock.getCode()), null, sortOrder);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
    ...
    public int deleteStockShare(Stock stock) {
        return delete(DatabaseContract.StockShare.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public int updateStockShare(StockShare stockShare, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockShare.CONTENT_URI, contentValues, getStockDateSelection(stockShare.getSE(), stockShare.getCode(), stockShare.getDate()),null);
    }
    ...
    public int deleteTDXData(Stock stock) {
        return delete(DatabaseContract.TDXData.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }

    public int deleteTDXData(String se, String code, String period) {
        return delete(DatabaseContract.TDXData.CONTENT_URI, getStockPeriodSelection(se, code, period), null);
    }
    ...
    public void getTDXDataContentList(Stock stock, String period, ArrayList<String> contentList) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryTDXData(getStockPeriodSelection(stock.getSE(), stock.getCode(), period), null, null);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                while (cursor.moveToNext()) {
    ...
    public int deleteStockTrend(Stock stock) {
        return delete(DatabaseContract.StockTrend.CONTENT_URI, getStockSelection(stock.getSE(), stock.getCode()), null);
    }
    ...
    public int updateStockTrend(StockTrend stockTrend, ContentValues contentValues) {
        ...
        return update(DatabaseContract.StockTrend.CONTENT_URI, contentValues, getStockPeriodLevelSelection(stockTrend.getSE(), stockTrend.getCode(), stockTrend.getPeriod(), stockTrend.getLevel()),null);
    }
    ...
    public void getStockTrendById(StockTrend stockTrend) {
        ...
        Cursor cursor = null;
        try {
            cursor = queryStockTrend(getIDSelection(stockTrend.getId()), null, null);
            if ((cursor != null) && (cursor.getCount() > 0)) {
                cursor.moveToNext();
                stockTrend.set(cursor);
            }
