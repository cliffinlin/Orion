...
public final class DatabaseContract {
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_CLASSES,
				...
				COLUMN_NET_PROFIT, COLUMN_DEBT_TO_NET_ASSETS_RATIO,
				COLUMN_BOOK_VALUE_PER_SHARE, COLUMN_CASH_FLOW_PER_SHARE,
				COLUMN_NET_PROFIT_PER_SHARE,
				COLUMN_NET_PROFIT_PER_SHARE_IN_YEAR,
				COLUMN_NET_PROFIT_PER_SHARE_LAST_YEAR, COLUMN_RATE, COLUMN_ROI,
				COLUMN_ROE, COLUMN_PE, COLUMN_PB, COLUMN_DATE, COLUMN_DIVIDEND,
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ DOUBLE_TYPE + COMMA_SEP + COLUMN_BONUS + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_VALUATION + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_TOTAL_SHARE + DOUBLE_TYPE + COMMA_SEP
				...
				+ COLUMN_NET_PROFIT_PER_SHARE_LAST_YEAR + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_RATE + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_ROI + DOUBLE_TYPE + COMMA_SEP + COLUMN_ROE
	...
	public static abstract class StockDeal implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_SE,
				COLUMN_CODE, COLUMN_NAME, COLUMN_PRICE, COLUMN_NET,
				COLUMN_DEAL, COLUMN_VOLUME, COLUMN_PROFIT, COLUMN_CREATED,
				COLUMN_MODIFIED };
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ COLUMN_NET + DOUBLE_TYPE + COMMA_SEP + COLUMN_DEAL
