...
public final class DatabaseContract {
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_CLASSES,
				...
				COLUMN_YEAR, COLUMN_OPERATION, COLUMN_OVERLAP,
				COLUMN_OVERLAP_LOW, COLUMN_OVERLAP_HIGH, COLUMN_POSITION,
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ COLUMN_OPERATION + TEXT_TYPE + COMMA_SEP + COLUMN_OVERLAP
	...
	public static abstract class StockDeal implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_SE,
				...
				COLUMN_NET, COLUMN_VOLUME, COLUMN_PROFIT, COLUMN_POSITION,
				COLUMN_HOLD, COLUMN_QUOTA, COLUMN_CREATED, COLUMN_MODIFIED };
