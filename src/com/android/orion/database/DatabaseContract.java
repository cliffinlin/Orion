...
public final class DatabaseContract {
	...
	public static abstract class FinancialData implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_STOCK_ID,
				COLUMN_DATE, COLUMN_TIME, COLUMN_BOOK_VALUE_PER_SHARE,
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				+ " INTEGER PRIMARY KEY," + COLUMN_STOCK_ID + TEXT_TYPE
				+ COMMA_SEP + COLUMN_DATE + TEXT_TYPE + COMMA_SEP + COLUMN_TIME
				+ TEXT_TYPE + COMMA_SEP + COLUMN_BOOK_VALUE_PER_SHARE
				+ DOUBLE_TYPE + COMMA_SEP + COLUMN_EARNINGS_PER_SHARE
				+ DOUBLE_TYPE + COMMA_SEP + COLUMN_CASH_FLOW_PER_SHARE
				+ DOUBLE_TYPE + COMMA_SEP + COLUMN_CURRENT_ASSETS + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_TOTALASSETS + DOUBLE_TYPE + COMMA_SEP
