...
public final class DatabaseContract {
	...
	public static abstract class Stock implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_CLASSES,
				...
				COLUMN_TOTAL_SHARE, COLUMN_BOOK_VALUE_PER_SHARE,
				COLUMN_CASH_FLOW_PER_SHARE, COLUMN_NET_PROFIT,
				COLUMN_NET_PROFIT_PER_SHARE, COLUMN_RATE, COLUMN_ROE,
				COLUMN_VALUATION, COLUMN_DISCOUNT, COLUMN_PE, COLUMN_PB,
				COLUMN_DIVIDEND_DATE, COLUMN_DIVIDEND, COLUMN_YIELD,
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ COMMA_SEP + COLUMN_BOOK_VALUE_PER_SHARE + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_CASH_FLOW_PER_SHARE + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_NET_PROFIT + DOUBLE_TYPE + COMMA_SEP
				...
				+ COMMA_SEP + COLUMN_DIVIDEND_DATE + TEXT_TYPE + COMMA_SEP
	...
	public static abstract class StockDeal implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_SE,
				...
				COLUMN_NET, COLUMN_ROE, COLUMN_PE, COLUMN_VOLUME,
				COLUMN_PROFIT, COLUMN_PROFIT, COLUMN_CREATED, COLUMN_MODIFIED };
		...
		private static final String CREATE_TABLE_CONTENT = " (" + _ID
				...
				+ DOUBLE_TYPE + COMMA_SEP + COLUMN_ROE + DOUBLE_TYPE
				+ COMMA_SEP + COLUMN_PE + DOUBLE_TYPE + COMMA_SEP
				+ COLUMN_VOLUME + INTEGER_TYPE + COMMA_SEP + COLUMN_PROFIT
	...
	public static abstract class FinancialData implements BaseColumns {
		...
		public static final String[] PROJECTION_ALL = { _ID, COLUMN_STOCK_ID,
				...
				COLUMN_NET_PROFIT, COLUMN_NET_PROFIT_PER_SHARE, COLUMN_CREATED,
				COLUMN_MODIFIED };
